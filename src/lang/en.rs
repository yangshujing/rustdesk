...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("full-control-tip", "Full Control gives others the same permissions as the address book owner."),
        ("share-warning-tip", "The fields above are shared and visible to others."),
    ].iter().cloned().collect();
}
