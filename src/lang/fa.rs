...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("switch_display_elevated_connections_tip", "هنگامی که چندین اتصال وجود دارد، تغییر به صفحه نمایش غیر اصلی در حالت کاربر با دسنرسی بالا پشتیبانی نمی شود. اگر می‌خواهید چند نمایشگر را کنترل کنید، لطفاً پس از نصب دوباره امتحان کنید."),
        ("input_source_1_tip", "منبع ورودی 1"),
        ("input_source_2_tip", "منبع ورودی 2"),
        ("capture_display_elevated_connections_tip", "ضبط چندین نمایشگر در حالت کاربر بالا پشتیبانی نمی شود. اگر می‌خواهید چند نمایشگر را کنترل کنید، لطفاً پس از نصب دوباره امتحان کنید."),
